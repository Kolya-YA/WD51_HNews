...
const Main = ({ news, hiddenNews, setHiddenNews }) => {
    ...
    useEffect(() => {
        setFiltredNews(news?.hits?.map(addHiddenKey).filter(filterHidden))
    }, [showHidden, news, hiddenNews])
        ...
        <main className="container mx-auto p-4">
            ...
            { Object.keys(news).length === 0
                ...
                : <>
                    ...
                    <InfoLine news={news.hits} filtredNews={filtredNews} showHidden={showHidden} setShowHidden={setShowHidden} />
